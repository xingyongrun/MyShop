...
<div id="content">
	...
	<div class="m-right">
			...
			<div class="main">
			<center>
				<form action="${ctx}/admin/edit" method="post">
					<table  border=1>
							<input type="hidden" name="id" value="${cake.id }" />
							<tr>
						 		 <td>蛋糕名称</td><td><input type="text" name="name" value="${cake.name }"/></td>
							</tr>
							<tr>
								  <td>价格</td><td><input type="text" name="price" value="${cake.price }"/></td>
							</tr>
							<tr>
								  <td>折扣价格</td><td><input type="text" name="discountprice" value="${cake.discountprice }"/></td>
							</tr>
							<tr>
						 		 <td>描述</td><td><input type="text" name="description" value="${cake.description }"/></td>
							</tr>
							<tr>
